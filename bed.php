...
<table border="0" align="center">
   ...
   <tr>
     ...
     <td><img src="n.jpg" height="126" width="123"></td>
     <td><img src="ee.jpg" height="126" width="123"></td>
     
   </tr>
   <tr>
     <td><input type="button" name="submit1"  id="submit1" value="ligON" style="width: 123px; height: 30px; font-size: 16px;"></td>
     <td><input type="button" name="submit5"  id="submit5" value="NigligON" style="width: 123px; height: 30px; font-size: 16px;"></td>
   ...
   <tr>
     ...
     <td><input type="button" name="submit6" id="submit6" value="NigligOFF" style="width:123px;font-size: 16px;height:30px;"></td>
